...
bool shopGiftLayer::init(){
    ...
    auto giftBtn2 = MenuItemSprite::create(Sprite::createWithSpriteFrameName("shop_tab_gift1.png"),
                                           ...
                                           CC_CALLBACK_0(shopGiftLayer::hideLayerCallFunc, this));
    
    giftBtn2->setAnchorPoint(Point::ANCHOR_MIDDLE_RIGHT);
    giftBtn2->setPosition(Origin+Point(visibleSize.width-508,visibleSize.height/2+100));
    
    menuBtn2 = Menu::create(giftBtn2, NULL);
    menuBtn2->setPosition(Origin+Point::ZERO);
    this->addChild(menuBtn2,4);
    ...
    buyItem01 = MenuItemLabel::create(LabelTTF::create("0.1元每日礼包", "", 40),
    ...
    m_ShopLayer->setPosition(Origin+Point::ZERO);
